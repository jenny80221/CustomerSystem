...
public partial class homepage : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            client.Credentials = new System.Net.NetworkCredential("jenny800221@gmail.com", "a1234321");
                 ...
                 do
                  {
                    ...
                    body += "http://localhost:64011/Product.aspx?=" + idRecords["email_ID"];
                    body += "</br>";
